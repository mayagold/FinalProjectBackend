...
class GearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post gears_url, params: { gear: { brand: @gear.brand, name: @gear.name, review: @gear.review, sport: @gear.sport, user_id: @gear.user_id } }, as: :json
    end
  ...
  test "should update gear" do
    patch gear_url(@gear), params: { gear: { brand: @gear.brand, name: @gear.name, review: @gear.review, sport: @gear.sport, user_id: @gear.user_id } }, as: :json
    assert_response 200
  end
